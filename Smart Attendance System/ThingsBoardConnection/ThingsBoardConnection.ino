...
void sendAttendanceDataToPhp(String rfidTagId, String timestamp); // Renamed for clarity
void sendTelemetryToThingsBoard(String rfidTagId, String timestamp); // New function prototype
void setupTime();
...
// New function: Sends telemetry data to ThingsBoard
